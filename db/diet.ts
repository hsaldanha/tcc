export const restrictionsDb: Array<Restriction> = [
  ...
  },
  {
    ...
    description: {
      ...
      treatment:
        "O tratamento consiste em evitar o consumo de laticínios, o consumo de produtos sem lactose e o uso de suplementação de lactase através de remédios",
      sources: [
        "Intolerância à lactose | Biblioteca Virtual em Saúde MS - https://bvsms.saude.gov.br/intolerancia-a-lactose/",
        "Intolerância à lactose - Portal Drauzio Varella - https://drauziovarella.uol.com.br/doencas-e-sintomas/intolerancia-a-lactose/",
      ],
    },
  },
  {
